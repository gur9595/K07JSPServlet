...
<body>
	...
	<%
		/*
		web/xml에서 설정할때는 분단위로 설정하고 만약 설정값이 없을때
		30분1800초로 설정된다 웹어플리케이션이 실행될때는 web.xml의 
		설정값이 먼저 실행되고 아래 JSP코드가 실행되게된다,
		*/
		//내장객체를 사용할꺠는 초단위로 설정한다
	...
	String creationTimerString = s.format(new Date(createTime));
	...
	<ul>
		<li>최초 요청시간 : <%=creationTimerString %></li>
