	...
	<div class="row">		
		...
		<div class="col-9 pt-3">
				...
				<tbody>
					...
					<tr>
						...
						<!-- 
							...
							저장되므로 HTML페이지에서 출력할떄는 <br/>태그로 문자열을 변경해야한다
						 -->
			...
			<div class="row mb-3">
				...
				%>
				<!-- 
				수정 삭제의 경우 특정게시물에 대해 수쟁하는 작업이므로 반드시
				게시물의 일련번호가 파라미터로 전달되어야 한다
				 -->
					<button type="button" class="btn btn-secondary" 
					onclick="location.href='BoardEdit.jsp?num=<%=dto.getNum()%>';">수정하기</button>
					<!-- 
					회원제 게시판에서 삭제처리는 별도의 폼이 필요없이 
					사용자에대한 인증만 되면 즉시 삭제처리한다
					 -->
				...
				<!-- 
				게시물 삭제의 경우 ㅎ로그인된 상태이므로 해당 게시물의 일련번호만
				서버로 전송하면 된다. 이때 hidden품을 사용하고, 
				JS의 submit()함수를 이용해 폼값을 전송한다.
