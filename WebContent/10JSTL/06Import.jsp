...
<body>
	...
	<!-- 
	 ...
	 -->
	<h3>var 속성 미지점 해당위치에 바로 삽입됨 (include 액션태그와 동일함)</h3>
	...
	<!-- 
		...
		차후원하는 위치에 변수를 출력하는 형태로 사용한다
		HTML소스가 좀 더 간결해지는 장점이있다
	 -->
	<h3>import 선언은 위에서 삽입은 아래서 처리</h3>
	${contents }
	
	<h3>외부(원격)에 있는 내용삽입하기</h3>
	<iframe src="./inc/ImportNate.jsp" frameborder="1" style="width:100%;heght:500px">
	</iframe>
