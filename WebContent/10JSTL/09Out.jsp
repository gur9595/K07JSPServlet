...
<body>
	...
	JS으ㅟ innerText()와 동일하다
	 -->
	<h3>escapeXml=true(기본값)일떄</h3>
	<c:out value="${htmlStr }" escapeXml="true" />
	<br />
	\${htmlStr } : ${htmlStr }
	
	<!-- 
	false 일때는 HTML이 해석되어져서 화면에 출력된다 . JS의 innerHTML()과 동일하다
	 -->
	...
	<!-- 
	-out태그에 value속성의 값이 null일떄는 default속성에 지정한 값이 출력된다
	-단 값이 빈문자열인경우는 값이 있는것으로 간주되어  default속성에 지정한 값이 출력되지 않는다
	 -->
	<h3>default속성</h3>
	...
	<!-- 
	 ...
	 -->
	<h3>페이지 링크에 응용하기</h3>
	<c:url value="/08Borad2/BoradList.jsp?nowPage="/>
