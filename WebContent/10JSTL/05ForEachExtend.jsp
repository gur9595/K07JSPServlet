...
<body>
	...
	forEach태그의 두번째 문법 : 확장 for문
		...
		varStatus에 지정된 값들중 index속성은 0부터 시작한다
	...
	<!-- JSP에서 생성한 배열을 JSTL에서 사용하기위해  set태그로 변수선언 -->
	...
	<%-- 
	루프내에서 객체를 전달할 변수  map을 통해 맵의 key값과 value값을 알아낼수있다
		키값 : ${맵의 이름 .key}
		벨류값 : ${맵의이름.value}
	 --%>
