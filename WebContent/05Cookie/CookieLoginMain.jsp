...
<body>
	...
	<%
	//세션영역에 저장된 속성값이 없다면 로그인폼을 출력한다.
	if(session.getAttribute("USER_ID")==null){
	%>
	<form action="CookieLoginProc.jsp" method="post">
	<!-- 
		input태그의 tabindex속성
		: 포커스 이동을 위해 ㅌ ㅐㅂ 키를 눌렀을떄 포커스가 이동하는 순서를 지정한다
		지정되지 않으면 input 태그가 작성된 순서대로 이동하게된다.
	 -->
	<table border="1">
		<tr>
		<td>아이디</td>
		...
		<!-- 변수user에 저장된 값이 있을때 checked 속성을 활성화 -->
	...
	<%
		...
		//서션영역에 저장된 속성값이 있다면 로그인 성공화면을 보여준다.
	%>
	<table border="1" width=400>
	<tr>
		<td align="center">
		<!-- 세션영역에 저장된 속성이 있으므로 getAttribute로 읽어올수 있다. -->
