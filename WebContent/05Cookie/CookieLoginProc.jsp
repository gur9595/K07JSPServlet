...
/*
	checkbox의 경우 항목이 여러개 이므로 주로 getParameterValues()를
	통해 배열로 받아와야하지만 항목이 하나만 있는 경우에는 아래와같이 처리가 가능하다
*/
String id_save = request.getParameter("id_save");
//JDBC연동없이 kosmo/1234일때 로그인 성공
if("kosmo".equals(userid)&&"1234".equals(userpw)){
	//회원인증이 완료된 경우에는 session영역에 속성저장
	...
	//포워드한 페이지는 리퀘스트 영역이 공유하므로 위에 저장한 속성을 읽어올수있다.
}
%>
