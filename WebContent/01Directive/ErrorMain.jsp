...
out.println("strAgr=" +strAge);

int ageAfter10= -1;
String errorStr ="";
/*
해당 페이지로 폼값을 전송할때 "나이" 부분은 공백상태 혹은 영문자를 전송하면
아래코드에서 에러가 발생된다. Integer.parseInt()의 인자로 숫자가 아닌
문자열이 전달되면 NumberFormatException이 발생된다.
*/
if(strAge !=null){
