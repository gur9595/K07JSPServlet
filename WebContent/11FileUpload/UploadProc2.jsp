...
try{
	...
	*/
	...
	/* 
	 ...
	 서버에서 문제가 될소지가 있으므로 숫자 혹은 영문으로 변경하는것이 좋다
	*/
////////////////////////////////////////////////////////////////////////////////////////////////////
//서버에 저장된 파일 가져오기
	String fileName = mr.getFilesystemName("chumFile1");
	//파일명을 변경하기위해 현재시간을 가져온다
	/* 
	...
	*/
	...
	/* 
		...
		마지막에있는 점을찾아온다 해당인덱스를 통해 확장자를 가져온다
	*/
	int idx=-1;
	...
	파일객체 separator : 파일경로를 나타낼때 윈도우 역슬러쉬 \
	리눅스는 슬러쉬 / 를 사용하게 되는데 OS에따라 구분기호를 
	자동으로 변환하여 설정해주는 역할을한다
	*/
...
<body>
	...
	<ul>
		...
		<li>
		서버에 저장된 파일명(변경전) : <%=mr.getFilesystemName("chumFile1") %>
		</li>
		<li>
		...
		<li>
		이미지표현 : <img src="../Upload/<%=realFileName %>" width="200" />
		</li>
	</ul>
