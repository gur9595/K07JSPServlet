...
<body>
   ...
   */
   ...
   String dateString = "";
   //Date 타입으로 형변환 가능한지 확인후 형변환한다...
   if(obj instanceof Date){
	   //가능하다면 Date 타입으로 형변환한다.
   ...
   <!-- 
   		...
   		속성값이 모두 파괴되어 소멸한다. 즉 다른페이지와는 속성이 공유되지않는다.
    -->
   <h2>페이지 이동</h2>
   <a href="PageResult.jsp">page영역 공유확인을 위한 링크</a>
   <br />
   <!-- 
   		외부파일 인클루드 하는경우 외부문서는 원본그대로 현재문서에
   		포함된후 컴파일되므로 include지시어를 사용하는경우
